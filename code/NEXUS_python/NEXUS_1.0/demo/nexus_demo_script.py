...
# Therefore to run steps 1 to 5 use: 'nexus_script.py 1 5'
#
#################################################################################################################################
...
binDir    = '../bin/'
# name of the input density file - on a 128 x 128 x 128 grid in a 100Mpc/h box length with LCDM cosmology
densityFile = 'demo_density.a_den'
...
nexus_response_1 = '{0}/MMF_response {1} 2-6 --den --node node'.format( binDir, densityFile )
...
nexus_response_2 = '{0}/MMF_response {1} 2-6 --logFilter --fila fila --wall wall'.format( binDir, densityFile )
